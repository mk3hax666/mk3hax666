      ...
      >
        <title id="titleId">mk3hax666 github status , Rank: A+</title>
        <desc id="descId">Total Stars Earned: 542, Total Commits  : 542, Total PRs: 25, Total Issues: 11, Contributed to: 2</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 114.20015242648516;
      }
    }
